...
const CardNFTVideo: FC<CardNFTVideoProps> = ({
  ...
  videoSrc,
  name = `NFT Video #${Math.floor(Math.random() * 1000) + 1000}`,
  price,
}) => {
    ...
    >
      ...
      <div className="p-5">
        <div className="flex justify-between items-center">
          <h2 className={`sm:text-lg font-semibold truncate`}>
        ...
        <div className="flex justify-between items-end mt-3.5">
          <Prices labelTextClassName="bg-white dark:bg-neutral-900 " price={price}/>
