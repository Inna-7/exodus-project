...
const DEMO_DATA = [
  {
    ...
    img: HIW1img,
    imgDark: HIW1img,
    title: "Login & discover",
    desc: 'Sign up/Login into Exodus Metaverse. Check the NFTs we have there',
  },
  {
    id: 2,
    img: HIW2img,
    ...
    desc: 'Connect your preferred wallet to be able to buy NFTs. You can find the wallets in "Discover" dropdown',
  },
  {
    id: 3,
    img: HIW3img,
    imgDark: HIW3img,
    title: "Start trading",
    desc: 'Click on the NFT you want and buy it from the details page with the value you prefer',
  },
  // {
  //   id: 4,
  //   img: HIW4img,
